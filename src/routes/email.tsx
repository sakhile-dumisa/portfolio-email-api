...
const VerificationEmail = ({ code = '000000' }: VerificationEmailProps) => (
...
const InboxEmail = ({ userName, message }: InboxEmailProps) => {
...
const ConfirmationEmail = ({ userName = 'there', sentMessage }: ConfirmationEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head>
      <Font
        fontFamily="Space Grotesk"
